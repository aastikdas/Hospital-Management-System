...
const userSchema = new mongoose.Schema({
    firstName:{
        type:String,
        required: true,
        minLength:[3,"First Name must contain more than 3 characters"]
    },
    lastName:{
        type:String,
        required: true,
    ...
    nic:{
        type:String,
        required:true,
        minLength:[13,"NIC must have 13 digits"],
        maxLength:[13,"NIC must have 13 digits"],
    },
    dob:{
        type:Date,
...
userSchema.methods.generateJsonWebToken = function () {
    return jwt.sign({id:this._id},process.env.JWT_SECRECT_KEY,{
        expiresIn: process.env.JWT_EXPRIRES,
    })
}
